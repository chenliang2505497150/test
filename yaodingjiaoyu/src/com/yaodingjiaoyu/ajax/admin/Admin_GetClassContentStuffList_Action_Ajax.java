...
//返回该校区所有的老师以及班主任列表
public class Admin_GetClassContentStuffList_Action_Ajax {
	...
	public String execute(){
		try {
			resultMap.clear();
			List<Stuff> stuff_Obj_list= pageListService.getcr_trListByCampus(campus);
			...
			logger.error(this.getClass().getName()+"-->execute:获得列表信息失败,MESSAGE:"+e.getMessage());
			return "error";
		}
		return null;
	}
