...
public class Cr_SaveHetong_Ajax {
	...
	public boolean checkInput() {
		...
		if ((course_type == 0) || (ht_property == 0) || (normal_hour == 0) || (subject == 0) || (now_class == 0)
				...
				|| ("".equals(phone1)) || ("".equals(phone2)) || ("".equals(parent_name)) || ("".equals(address))
				|| ("".equals(hetong_num))) {
			success = false;
		} else {
			success = true;
	...
	public void doRequest() {
		...
		if (checkInput()) {// 健壮性判断
			...
			if (student_id != 0) {
				...
				if (classhour_id != 0) {
					// 更新合同表
					hetong_id = saveHetongService.saveHetong(2, student_id, hetong_num, level, subject, normal_hour,
