...
public class Cr_SearchHetong_Ajax {
	...
	public String execute(){
		...
		try {
			...
			logger.error(this.getClass().getName()+"-->execute:保存合同信息失败。参数start_look："+start_look+",name:"+name+
					",school:"+school+",level:"+level+",time1:"+time1+",time2:"+
					time2+",hetong_type:"+hetong_type+",hetong_num:"+hetong_num+",course_type:"+course_type
					+",stuff:"+stuff+",campus:"+campus+",MESSAGE:"+e.getMessage());
			return "error";
		}
		return null;
	}
