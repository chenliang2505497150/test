...
public class Sd_SearchHetong_Ajax {
	...
	private void doSearchHetong() {
		...
		Double total_money = searchHetongService.findHetong_Sum_Money(hetong_num, name, school, level, hetong_type,
				campus + "", stuff, course_type, time1, time2);
		...
		resultMap.put("total_money", total_money);
	}
	...
	public String execute() {
		...
		try {
			...
			logger.error(this.getClass().getName() + "-->execute:查询例子失败。参数start_look：" + start_look + ",name:" + name
					+ ",time1:" + time1 + ",time2:" + time2 + ",level:" + level + ",school:" + school + ",hetong_type:"
					+ hetong_type + ",course_type:" + course_type + ",hetong_num:" + hetong_num + ",stuff:" + stuff
