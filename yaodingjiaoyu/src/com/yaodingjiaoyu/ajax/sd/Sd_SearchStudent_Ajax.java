...
public class Sd_SearchStudent_Ajax {
	...
	private void doSearchStudent() {
		...
		List<Student> list = searchStudentService.findBySdRequest(name, school, level, stu_class, telephone, stu_status,
				campus + "", status, stuff);
		// 初始化各个列表默认的信息
	...
	public String execute() {
		...
		try {
			...
			logger.error(this.getClass().getName() + "-->execute:查询例子失败。参数start_look：" + start_look + ",name:" + name
					+ ",telephone:" + telephone + ",stu_class:" + stu_class + ",level:" + level + ",school:" + school
					+ ",stu_status:" + stu_status + ",stuff:" + stuff + ",SdId:"
