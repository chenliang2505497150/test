...
public class Sd_SaveExamples_Aajx {
	...
	public String execute() {
		...
		try {
			...
			logger.error(this.getClass().getName() + "-->execute:初始化学生列表失败。参数name：" + name + ",school:" + school
					+ ",level:" + level + ",now_class:" + now_class + ",phone1:" + phone1 + ",phone2:" + phone2
					+ ",address:" + address + ",zhuangtai:" + zhuangtai + ",probability:" + probability + ",channel:"
					+ channel + ",stuff:" + stuff + ",SdId:" + ActionContext.getContext().getSession().get("ID")
