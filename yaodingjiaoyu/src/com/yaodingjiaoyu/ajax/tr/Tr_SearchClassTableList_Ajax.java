...
public class Tr_SearchClassTableList_Ajax {
	...
	private void doLoad() {
		...
		List<ClassTable> list = classTableService.findTrClassTable(subject, stuff, student, time1, time2, status,
				class_time, campus, course_type, level);
	...
	public String execute() {
		...
		try {
			...
			logger.error(this.getClass().getName() + "-->execute:查询例子失败。参数start_look：" + start_look + ",student:"
					+ student + ",time1:" + time1 + ",time2:" + time2 + ",level:" + level + ",subject:" + subject
					+ ",class_time:" + class_time + ",course_type:" + course_type + ",status:" + status + ",TrId:"
