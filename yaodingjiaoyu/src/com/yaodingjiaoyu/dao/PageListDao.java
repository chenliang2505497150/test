...
public interface PageListDao {
	...
	public List<Stuff> getcr_ccListByCampus(String campus);//获得该校区所有的销售
	public List<Stuff> getcr_trListByCampus(String campus);//获得该校区所有的老师和班主任
	public List<Stuff> getTrListByCampus(String campus);//获得该校区所有的老师
	...
	public List<ClassTime> getClassTimeList();//获得
}
