...
public class Tr_StuInfo_Action1 {
	...
	public String execute() {
		...
		try {
			...
			List<Map<String, Object>> list = searchStudentService.findByTrRequest_MAP("", "", "no", "", "", stuff,
					campus);
			List<Map<String, Object>> tmp = (List<Map<String, Object>>) getResultObjectListService
					.getResultObjectList(1, PAGE_MAX, list);// 显示前15行数据
			// 处理，将部分的内容进行翻译
