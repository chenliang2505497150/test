...
public class Achievement_CR_Action {
	/*
	 * 需求：班主任系统的业绩列表主要显示班主任的：姓名、校区、金额按照金额进行排名 可以添加筛选框：姓名、时间段、校区 数据准备：1.校区列表
	 * 2.班主任业绩排名列表
	 */
	...
	public String execute() {
		try {
			...
			List<Map<String, Object>> list = achievementService.getCrAchievement("", "", "", "no");
