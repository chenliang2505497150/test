...
public class Sd_ClassTable_Action1 {
	//显示列表形式的课表
	...
	private void loadClassTable() {
		...
		List<ClassTable> list =classTableService.findClassTable("no", null, "no", "", "", "", "no", "no", campus, "no", "no");
		...
		stuff_list = pageListService.getcrListByCampus(campus);
