...
public class Cr_Classtable_Action2 {
	//显示列表形式的课表
	...
	public String execute(){
		try {
			...
			List<ClassTable> list =classTableService.findClassTable("no", null, stuff, "", "", "", "no", "no", campus, "no", "no");
			...
			logger.error(this.getClass().getName()+"-->execute:加载课表失败,MESSAGE:"+e.getMessage());
			return "error";
		}
	}
}
