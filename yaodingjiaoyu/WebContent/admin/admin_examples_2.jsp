	...
	function LoadData(result_obj){
		...
		if(result_obj.examplesList != null){
			...
			for(var i=0;i<result_obj.examplesList.length;i++){
				...
				var td3 = "<td>"+result_obj.examplesList[i].insertTime+"</td>";
				var td4 = "<td class = 'center'>"+result_obj.examplesList[i].contents+"</td>";
				var td5 = "<td class = 'center'>"+result_obj.examplesList[i].campus+"</td>";
				var td6 = "<td class = 'center'>"+result_obj.examplesList[i].stuff+"</td>";
				var tr_end = "</tr>";
	            
				var html = tr_start + td1 + td2 + td3 + td4 + td5 + td6 + tr_end;
	                
				
				$("#cc_contentList").append(html);
									    ...
									    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									      <form class="navbar-form navbar-left" role="search" name = "search_cc_content">
									        <div class="form-group">
								            	...
								            	销售:<s:select list="#{'no':'－－－－'}"   class="selectbox" name = "cc" id = "cc" style="width:100px" theme="simple"/>
	                                ...
	                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                                    ...
	                                    <s:iterator value="ccContentList" id = "cc_content" status = "sta">
	                                    	...
	                                    	<tr class="odd gradeX">
	                                            ...
	                                            <td class="center"><s:property value="#cc_content.campus"/></td>
