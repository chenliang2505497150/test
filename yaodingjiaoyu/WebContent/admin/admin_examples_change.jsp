						...
						<div class="panel-body">
		                   <div class="table-responsive">
		                   		<table class="table table-striped table-bordered table-hover">
									...
									<tr class="odd gradeX">
										<td>父亲电话:</td>
										<td><input type = "text" name = "phone1" value="${examples.phone1}"/></td>
									</tr>
									
									<tr class="odd gradeX">
										<td>母亲电话:</td>
										<td><input type = "text" name = "phone2" value="${examples.phone2}"/></td>
									</tr>
									...
									<tr class="odd gradeX">
										<td>校区:</td>
										<td><s:select list="campus_list" listKey="PId" listValue="name" value = "examples.campus.PId" class="selectbox" name = "campus"  style="width:153px" theme="simple"/></td>
									</tr>
