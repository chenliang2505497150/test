...
<title>欢迎您，管理员:<s:property value="stuff.name" /></title>
<!-- Bootstrap Styles-->
		...
		<ul class="nav navbar-top-links navbar-right">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li><a href="javascript:void(0);" id="trigger"><i
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="javascript:void(0);"><i class="fa fa-sitemap"></i>
					...
					<ul class="nav nav-second-level">
						<li><a id = "account_create" href="javascript:void(0);">账号创建</a></li>
					</ul>
				</li>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			function BindTableClick() {
				...
				var $trigger = $("#trigger"); //jQuery 对象
				var trigger = $trigger[0]; //DOM 对象
				trigger.removeEventListener('click', dlg.toggle.bind(dlg));
			...
			$("#look_examples").click(function() {
				//do something
				htmlobj = $.ajax({
					url : "admin_examples?id=1",
					async : false
				});
				$("#page-wrapper").html(htmlobj.responseText);
				return false;
			});
			//account_create创建账号的点事件
			
			$("#account_create").click(function() {
				//do something
				htmlobj = $.ajax({
					url : "admin_stuff_manager?id=1",
					async : false
				});
				$("#page-wrapper").html(htmlobj.responseText);
				return false;
