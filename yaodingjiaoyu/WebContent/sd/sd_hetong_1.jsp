	...
	function LoadData(result_obj){
		...
		if(result_obj.Contennt_list != null){
			...
			for(var i=0;i<result_obj.Contennt_list.length;i++){
				...
				var option = "<option value='no'>－－－－</option><option value='hetong_detail'>详情</option><option value='delete_hetong'>删除合同</option>";
				var select_end = "</select>";
				var tdmore = tdmore_start + div_start + select_start + option + select_end + div_end + tdmore_end;
				var tr_end = "</tr>";
	            
				var html = tr_start + td1 + td2 + td3 + td4 + td5 + td6 +td7+ td8 + td9 + td10 + td11 + tdmore+ tr_end;
		...
		$("#total_money").text(result_obj.total_money);
	}
									    ...
									    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									      <form class="navbar-form navbar-left" role="search" name = "search_content">
									        <div class="form-group">
								            	...
								            	签约人：<s:select list="stuff_list" listKey="PId" listValue="name" headerKey="no" headerValue="－－－－" class="selectbox" name = "stuff" style="width:100px" theme="simple"/>
	                                ...
	                                <div class="row">
										<div class="col-sm-6">
											<div class="dataTables_info" id="dataTables-example_info" role="alert" aria-live="polite" aria-relevant="all">
												...
												总金额:<span id = "total_money"><s:property value = "total_money"/></span>
											</div>
										</div>
											<div class="col-sm-6">
												<!-- 在此处添加分页插件 -->
