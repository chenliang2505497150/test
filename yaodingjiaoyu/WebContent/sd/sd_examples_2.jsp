									    ...
									    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									      <form class="navbar-form navbar-left" role="search" name = "search_cc_content">
									        <div class="form-group">
								            	销售：<s:select list="stuff_list" listKey="PId" listValue="name" headerKey="no" headerValue="－－－－" class="selectbox" name = "stuff"  style="width:100px" theme="simple"/>
