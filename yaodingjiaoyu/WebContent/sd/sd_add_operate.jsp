						...
						<div class="panel-body">
		                   <div class="table-responsive">
		                   		<table class="table table-striped table-bordered table-hover">
									...
									<tr class="odd gradeX">
										<td>合同类型:</td>
										<td><s:select list="#{'2':'续费','3':'退费','4':'赠送'}" class="selectbox" name = "hetong_type" style="width:200px" theme="simple"/></td>
									</tr>
									
									<tr class="odd gradeX">
										<td>签约人:</td>
										<td><s:select list="stuff_list" listKey="PId" listValue="name"  class="selectbox" name = "stuff" style="width:200px;text-align:center;" theme="simple"/></td>
									</tr>
