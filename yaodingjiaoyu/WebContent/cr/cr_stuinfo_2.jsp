	...
	function LoadData(result_obj){
		...
		if(result_obj.Contennt_list != null){
			...
			for(var i=0;i<result_obj.Contennt_list.length;i++){
				...
				var td7 = "<td class = 'center'>"+result_obj.Contennt_list[i].campus+"</td>";
				var tr_end = "</tr>";
	            
				var html = tr_start + td1 + td2 + td3 + td4 + td5 + td6 +td7+ tr_end;
									    ...
									    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									      <form class="navbar-form navbar-left" role="search" name = "search_class_content">
									        <div class="form-group">
								            	...
								            	<p>
								            	学生姓名:<input class="form-control" name = "student" type="text"> 
								            	添加人:<s:select list="tr_list" listKey="P_ID" listValue="name" headerKey="no" headerValue="－－－－" class="selectbox" name = "stuff"  style="width:100px" theme="simple"/>
