...
$(document).ready(function() {
	...
	function doDeleteClass() {
		...
		var classtable_list = getClassTableList();
		//判断选中是不是空
	...
	function doConfirmClass() {
		...
		if(classtable_list.length == 0){
			...
			$.ajax({
                type: "post",
                url: "cr_confirm_classtable_list",
                async: false,
                data: { 
                	classtable_list_json: JSON.stringify(json),
                },
	...
	function LoadData(result_obj){
		...
		if(result_obj.Contennt_list != null){
			...
			for(var i=0;i<result_obj.Contennt_list.length;i++){
				...
				var option = "<option value='no'>－－－－</option><option value='cr_confirm_classtable'>确认已上</option><option value='cr_delete_classtable'>删除课程</option>";
...
<body>
			<menu class="menu">
			    ...
			    <li class="menu-item">
			        <button type="button" class="menu-btn trigger" id = "delete">
			            <i class="fa fa-folder-open"></i>
	                                            ...
	                                            <td class="center">
		                                            <div>
		                                            		<select class="selectbox" name="operate" id ="${id}"  style="width:100px" >  
					                                                ...
					                                                <option value="cr_delete_classtable">删除课程</option>
					                                        </select>
		                                            </div>
	                                    		</td>
	                                        </tr>
