...
<script type="text/javascript">
	$(document).ready(function(){
		...
		//表单的重置按钮
		$("a[name=reset_cc_add_hetong]").click(function(){
			$("form[name=cc_add_hetong]")[0].reset();
			$(".selectbox").select2();//刷新select样式
		});
		
		
		//表单的提交
		$("a[name=submit_cc_add_hetong]").click(function(){
			submitExamples();//上传例子
		});
...
<body>
	<div id="page-inner"> 
		...
		<form name = "cc_add_hetong" >
			<table class="table table-striped table-bordered table-hover">
			
			<caption align="top">请填写下面的表格添加新签合同</caption>
				...
				<tr class="odd gradeX">
					<td colspan="2" align="center">
						<a name = "reset_cc_add_hetong" href="javascript:void(0);" class="btn btn-warning">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
						<a name = "submit_cc_add_hetong" href="javascript:void(0);" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提交&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
					</td>
				</tr>
			</table>
		</form> 
