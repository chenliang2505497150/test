...
<!-- Bootstrap Styles-->
    ...
    <script type="text/javascript">
	    $(document).ready(function() {
			...
			//表单的提交
			$("a[name=submit_cc_add_content]").click(function(){
				AddContent();//修改例子
			});
			...
			function AddContent(){
		        ...
		        $.ajax({
		                ...
		                success: function (data, status) {
		                		...
		                		//alert(result_obj.message);根据客户的要求不弹框
		                		//刷新下方的跟踪记录信息
		                		getPageAjax();
		                },
			...
			function LoadData(result_obj){
				...
				if(result_obj.ContentList != null){
					...
					for(var i=0;i<result_obj.ContentList.length;i++){
						...
						var html = tr_start + td1  + td3 + td4 + td6 + tr_end;
		                   ...
		                   <div class="table-responsive">
	                            ...
	                            <div class="table-responsive">
	                                ...
	                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                                    ...
	                                    <tbody id = "examples_info">
	                                    	<tr class="odd gradeX">
	                                            <td class="center">
	                                            	<input type="text" class="form-control" placeholder="Text input" name = "id" disabled="disabled" value="${examples.PId}" style="width:100px">
	                                            </td>
	                                            <td class="center"><s:property value="examples.name"/></td>
	                                            <td class="center"><s:property value="examples.school"/></td>
	                                            <td class="center">
	                                            	<s:select list="level_list" listKey="PId" listValue="name" value = "examples.level.PId"  class="selectbox" name = "level"  style="width:80px" theme="simple" disabled="true"/>
	                                            </td>
	                                            <td class="center"><s:property value="examples.nowClass"/></td>
	                                            <td class="center"><s:property value="examples.phone1"/></td>
	                                            <td class="center"><s:property value="examples.phone2"/></td>
	                                            <td class="center"><s:property value="examples.address"/></td>
	                                            <td class="center">
	                                            	<s:select list="#{'0':'未上门','1':'已上门'}" value = "examples.zhuangtai" class="selectbox" name = "zhuangtai"  style="width:90px" theme="simple"/>
	                                            </td>
	                                            <td class="center">
	                                            	<s:select list="channel_list" listKey="PId" listValue="name" value = "examples.channel.PId" class="selectbox" name = "channel"  style="width:80px" theme="simple" disabled="true"/>
	                                            </td>
	                                        </tr>
	                                    </tbody>
	                                </table>
		                   		...
		                   		<table class="table table-striped table-bordered table-hover">
									...
									<tr class="odd gradeX">
										<td>是否有效:</td>
										<td><s:select list="#{'0':'无效','1':'有效'}"  value = "examples.youxiao" class="selectbox" name = "youxiao"  style="width:100px" theme="simple"/></td>
									</tr>
									
									<tr class="odd gradeX">
										<td>可能性:</td>
										<td><s:select list="probability_list" listKey="PId" listValue="name" value = "examples.probability.PId" class="selectbox" name = "probability" style="width:100px" theme="simple"/></td>
									</tr>
									...
									<tr class="odd gradeX">
										<td colspan="2" align="center">
											<a name = "submit_cc_add_content" href="javascript:void(0);" class="btn btn-success">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;提&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
										</td>
									</tr>
								</table>	
		                   </div>
