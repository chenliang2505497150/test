	...
	function LoadData(result_obj){
		...
		if(result_obj.studentList != null){
			...
			for(var i=0;i<result_obj.studentList.length;i++){
				...
				var option = "<option value='no'>－－－－</option><option value='tr_add_content'>添加回访</option><option value='tr_student_detail'>详情</option>";
				var select_end = "</select>";
				var td10 = td10_start + div_start + select_start + option + select_end + div_end + td10_end;
				var tr_end = "</tr>";
	            
				var html = tr_start + td1 + td2 + td3 + td4 + td5 + td6 + td7 + td8 + td10 + tr_end;
	                                            ...
	                                            <td class="center">
		                                            <div>
		                                            		<select class="selectbox" name="operate" id ="${id}"  style="width:100px" >  
					                                                ...
					                                                <option value="tr_add_content">添加回访</option>
					                                                <option value="tr_student_detail">详情</option>
					                                        </select>
		                                            </div>
	                                    		</td>
	                                        </tr>
