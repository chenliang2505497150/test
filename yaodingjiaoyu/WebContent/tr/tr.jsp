...
<title>欢迎您，老师:<s:property value="stuff.name" /></title>
<!-- Bootstrap Styles-->
...
<!-- 弹框的内容 -->
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a href="javascript:void(0);"><i class="fa fa-sitemap"></i>
					...
					<ul class="nav nav-second-level">
						<li><a id="lookClasstable" href="javascript:void(0);">查看课表</a>
							<a id="lookClasstable_list" href="javascript:void(0);">统计课表</a></li>
					</ul></li>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#lookClasstable_list").click(function() {
				//do something
				htmlobj = $.ajax({
					url : "tr_classtable?id=2",
					async : false
				});
				$("#page-wrapper").html(htmlobj.responseText);
				return false;
